...
public class LenguajeLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"SI", "SINO", "MIENTRAS", "IMPRIMIR", "LEER", "RETORNAR", "VACIO", "ENTERO", 
			"REAL", "CADENA", "BOOLEANO", "VERDADERO", "FALSO", "PAR_IZQ", "PAR_DER", 
			"LLAVE_IZQ", "LLAVE_DER", "FIN_SENT", "COMA", "IGUAL", "IGUAL_IGUAL", 
			"DIFERENTE", "MENOR", "MENOR_IGUAL", "MAYOR", "MAYOR_IGUAL", "MAS", "MENOS", 
			"POR", "DIV", "Y_LOGICO", "O_LOGICO", "NO", "ID", "NUMERO", "CADENA_LIT", 
			"ESC", "HEX", "WS", "COMENTARIO_LINEA", "COMENTARIO_BLOQUE"
		};
	}
