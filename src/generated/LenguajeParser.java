...
public class LenguajeParser extends Parser {
	...
	public final LeerContext leer() throws RecognitionException {
		...
		try {
			...
			match(PAR_IZQ);
			setState(349);
			((LeerContext)_localctx).t = tipo();
			setState(350);
			match(PAR_DER);

			          ((LeerContext)_localctx).info =  new ValorSemantico((((LeerContext)_localctx).t!=null?_input.getText(((LeerContext)_localctx).t.start,((LeerContext)_localctx).t.stop):null), null);
