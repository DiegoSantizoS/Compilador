	...
	public final AsignacionContext asignacion() throws RecognitionException {
		...
		try {
			...
			((AsignacionContext)_localctx).e = expresion();
			          ...
			          symbolTable.put((((AsignacionContext)_localctx).ID!=null?((AsignacionContext)_localctx).ID.getText():null), ((AsignacionContext)_localctx).e.value);
	...
	public final AndExprContext andExpr() throws RecognitionException {
		...
		try {
			...
			((AndExprContext)_localctx).a1 = igualdad();
			 ((AndExprContext)_localctx).value =  ((AndExprContext)_localctx).a1.value; 
			setState(153);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==Y_LOGICO) {
				...
				((AndExprContext)_localctx).a2 = igualdad();
				 ((AndExprContext)_localctx).value =  (_localctx.value != 0 && ((AndExprContext)_localctx).a2.value != 0) ? 1 : 0; 
				}
				}
				setState(155);
				_errHandler.sync(this);
		...
		try {
			...
			case CADENA_LIT:
				...
				((UnarioContext)_localctx).p = primario();
				 ((UnarioContext)_localctx).value =  ((UnarioContext)_localctx).p.value; 
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final PrimarioContext primario() throws RecognitionException {
		...
		try {
			...
			case VERDADERO:
				...
				setState(244);
				match(VERDADERO);
				 ((PrimarioContext)_localctx).value =  1; 
				}
				break;
			case FALSO:
				enterOuterAlt(_localctx, 4);
